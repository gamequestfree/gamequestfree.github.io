...
};
{
    ...
    window.DOMElementHandler = class extends self.DOMHandler {
        ...
        _OnCreate(t) {
            ...
            const o = this._GetFocusElement(s);
            o.addEventListener("focus", (e => this._OnFocus(i))), o.addEventListener("blur", (e => this._OnBlur(i)));
            const a = t.htmlIndex;
            if (n.SetWantHTMLIndex(a), n.SetHTMLZIndex(t.htmlZIndex), this._autoAttach) {
        ...
        _OnUpdatePosition(e) {
            ...
            const o = e.htmlIndex;
            t.SetWantHTMLIndex(o);
            const a = s.GetAvailableHTMLIndex(o);
            a !== t.GetActualHTMLIndex() && (i.remove(), s.GetHTMLWrapElement(a).appendChild(i), t.SetActualHTMLIndex(a), s._UpdateHTMLElementsZOrder());
    ...
    const t = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent),
        ...
        d = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/|nwjs)/i.test(navigator.userAgent);
    let l = 0;
    ...
    const x = new Set(["cordova", "playable-ad-single-file", "playable-ad-zip", "instant-games"]);
    ...
    window.RuntimeInterface = class e {
        ...
        IsiOSWebView() {
            ...
            return t && L(this._exportType) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
        }
        IsAndroid() {
            return n
        }
        IsAndroidWebView() {
            return n && L(this._exportType)
        }
        IsWindowsWebView2() {
        ...
        async _Init(e) {
            if (this._useWorker && (await u() || (this._useWorker = !1)), "macos-wkwebview" === this._exportType && this._SendWrapperMessage({
                    type: "ready"
        ...
        async _InitWorker(e, t) {
            ...
            o.className = "c3htmlwrap", o.setAttribute("interactive", ""), document.body.appendChild(o), this._canvasLayers.push({
                canvas: s,
                htmlWrap: o,
            ...
            }), [t, n, ...this._jobScheduler.GetPortTransferables()]), this._domHandlers = R.map((e => new e(this))), this._FindRuntimeDOMHandler(), this._runtimeDomHandler._AddDefaultCanvasEventHandlers(s), this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(o), this._runtimeDomHandler._EnableWindowResizeEvent(), self.c3_callFunction = (e, t) => this._runtimeDomHandler._InvokeFunctionFromJS(e, t), "preview" === this._exportType && (self.goToLastErrorScript = () => this.PostToRuntimeComponent("runtime", "go-to-last-error-script"))
        }
        async _InitDOM(e, t) {
            ...
            }), window.c3canvas = i, self.C3_InsertHTMLPlaceholders && self.C3_InsertHTMLPlaceholders(), this._domHandlers = R.map((e => new e(this))), this._FindRuntimeDOMHandler(), this._runtimeDomHandler._AddDefaultCanvasEventHandlers(i), this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(s);
            const n = await Promise.all(e.runtimeScriptList.map((e => this._MaybeGetPlatformSpecificScriptURL(e))));
            await Promise.all(n.map((e => c(e))));
            const o = e.projectMainScriptPath,
                a = e.javaScriptInEventsPath,
                r = e.typeScriptInEventsPath;
            if (o) try {
                if (await c(o), "preview" === this._exportType && !globalThis.C3_ProjectMainScriptOK) throw new Error("main script did not run to completion")
            } catch (e) {
            ...
            if (a) try {
                if (await c(a), "preview" === this._exportType && !globalThis.C3.JavaScriptInEvents) throw new Error("JavaScript in events did not run to completion")
            } catch (e) {
            ...
            if (r) try {
                if (await c(r), "preview" === this._exportType && !globalThis.C3.TypeScriptInEvents) throw new Error("TypeScript in events did not run to completion")
            } catch (e) {
            ...
            const d = Object.assign(this._GetCommonRuntimeOptions(e), {
                isInWorker: !1,
                messagePort: t,
                canvas: i,
                runOnStartupFunctions: M
            });
            this._runtimeDomHandler._EnableWindowResizeEvent(), this._OnBeforeCreateRuntime(), this._localRuntime = self.C3_CreateRuntime(d), await self.C3_InitRuntime(this._localRuntime, d)
        }
        ...
        _OnUpdateCanvasSize(e) {
            ...
            for (const {
                ...
                of this._canvasLayers) e.style.width = t, e.style.height = i, e.style.marginLeft = s, e.style.marginTop = n, o.style.width = t, o.style.height = i, o.style.marginLeft = s, o.style.marginTop = n, this._isFirstSizeUpdate && (e.style.display = "", o.style.display = "");
            ...
            if (t < this._canvasLayers.length)
                for (; this._canvasLayers.length > t;) {
                    ...
                    for (let e = 0, i = t - this._canvasLayers.length; e < i; ++e) {
                        ...
                        t.classList.add("c3htmlwrap", "c3overlay"), t.setAttribute("interactive", ""), document.body.appendChild(t), e.style.width = n, e.style.height = o, e.style.marginLeft = a, e.style.marginTop = r, t.style.width = n, t.style.height = o, t.style.marginLeft = a, t.style.marginTop = r, this._runtimeDomHandler._AddDefaultCanvasEventHandlers(e), this._runtimeDomHandler._AddDefaultHTMLWrapEventHandlers(t), this._canvasLayers.push({
                            canvas: e,
                            htmlWrap: t,
                            lastHtmlLayerDomState: {
                                isVisible: !0,
        ...
        _UpdateHTMLLayerDOMProperties(e) {
            for (let t = 0, i = Math.min(this._canvasLayers.length, e.length); t < i; ++t) {
                ...
                } = this._canvasLayers[t], n = e[t], o = n.isVisible, a = n.opacity, r = n.isInteractive;
                o !== s.isVisible && (i.style.display = o ? "" : "none", s.isVisible = o), a !== s.opacity && (i.style.opacity = 1 === a ? "" : String(a), s.opacity = a), r !== s.isInteractive && (i.style.pointerEvents = r ? "" : "none", r ? i.setAttribute("interactive", "") : i.removeAttribute("interactive"), s.isInteractive = r)
            }
        }
        ...
        _DoUpdateHTMLElementsZOrderOnHTMLLayer(e, t) {
            ...
            const i = t.map((e => e.GetElement())),
                ...
                o = Array.from(n.children).filter((e => s.has(e)));
            for (let e = 0, t = 0, s = i.length; e < s; ++e) {
                const s = i[e],
                    a = o[t];
                s === a ? ++t : n.moveBefore ? n.moveBefore(s, a) : n.insertBefore(s, a)
            }
        }
        _GetLocalRuntime() {
        ...
        _OnResultFromRuntime(e) {
            const t = e.responseId,
                ...
                s = e.result,
                n = O.get(t);
            i ? n.resolve(s) : n.reject(s), O.delete(t)
        }
        AddRuntimeComponentMessageHandler(e, t, i) {
            let s = T.get(e);
            if (s || (s = new Map, T.set(e, s)), s.has(t)) throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
            s.set(t, i)
        }
        static AddDOMHandlerClass(e) {
            if (R.includes(e)) throw new Error("DOM handler already added");
            R.push(e)
        }
        ...
        static IsDocumentFullscreen() {
            return !!(document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || N)
        }
        ...
        CordovaFetchLocalFileAsArrayBuffer(e) {
            return new Promise(((t, i) => {
                b.push({
                    ...
                    errorCallback: e => {
                        P--, this._CordovaMaybeStartNextArrayBufferRead(), i(e)
                    }
    ...
    const q = new Set(["input", "textarea", "datalist", "select"]),
        z = new Set(["canvas", "body", "html"]);

    function j(e) {
        if (!e.target.tagName) return;
        const t = e.target.tagName.toLowerCase();
        z.has(t) && e.preventDefault()
    }
    ...
    const $ = "runtime",
        J = class extends self.DOMHandler {
            ...
            _AddDefaultCanvasEventHandlers(e) {
                e.addEventListener("selectstart", j), e.addEventListener("gesturehold", j), e.addEventListener("pointerdown", j)
            }
            _AddDefaultHTMLWrapEventHandlers(e) {
                e.addEventListener("selectstart", X), e.addEventListener("gesturehold", X), e.addEventListener("touchstart", X)
            }
            _OnBeforeStartTicking() {
                return self.setTimeout((() => {
                    this._enableAndroidVKDetection = !0
                }), 1e3), "cordova" === this._iRuntime.GetExportType() ? (document.addEventListener("pause", (() => this._OnVisibilityChange(!0))), document.addEventListener("resume", (() => this._OnVisibilityChange(!1)))) : document.addEventListener("visibilitychange", (() => this._OnVisibilityChange("hidden" === document.visibilityState))), this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !Y), {
            ...
            Attach() {
                window.addEventListener("focus", (() => this._PostRuntimeEvent("window-focus"))), window.addEventListener("blur", (() => {
                    ...
                    var t;
                    t = e.target, (q.has(t.tagName.toLowerCase()) || V(t)) && this._PostRuntimeEvent("keyboard-blur")
                })), window.addEventListener("keydown", (e => this._OnKeyEvent("keydown", e))), window.addEventListener("keyup", (e => this._OnKeyEvent("keyup", e))), window.addEventListener("mousedown", (e => this._OnMouseEvent("mousedown", e, W))), window.addEventListener("mousemove", (e => this._OnMouseEvent("mousemove", e, W))), window.addEventListener("mouseup", (e => this._OnMouseEvent("mouseup", e, W))), window.addEventListener("dblclick", (e => this._OnMouseEvent("dblclick", e, F))), window.addEventListener("wheel", (e => this._OnMouseWheelEvent("wheel", e, F))), window.addEventListener("pointerdown", (e => {
            ...
            _OnFullscreenChange() {
                if (this._isExportToVideo) return;
                const e = G.IsDocumentFullscreen();
            ...
            _OnKeyEvent(e, t) {
                ...
                if ("Backspace" === t.key && j(t), "nwjs" === this._iRuntime.GetExportType() && "u" === t.key && (t.ctrlKey || t.metaKey) && t.preventDefault(), this._isExportToVideo) return;
                const i = H.get(t.code) || t.code;
            ...
            _OnMouseEvent(e, t, i) {
                this._isExportToVideo || D(t) || this._PostToRuntimeMaybeSync(e, {
                    button: t.button,
                    buttons: t.buttons,
                    clientX: t.clientX,
                    clientY: t.clientY + this._vkTranslateYOffset,
            ...
            _OnPointerEvent(e, t) {
                ...
                "mouse" === t.pointerType && (i = this._mousePointerLastButtons), this._PostToRuntimeMaybeSync(e, {
                    ...
                    twist: t.twist || 0,
                    timeStamp: t.timeStamp
                }, F), "mouse" === t.pointerType && (this._mousePointerLastButtons = t.buttons)
            }
    ...
    G.AddDOMHandlerClass(J)
} {
    const Q = "dispatchworker.js",
        ee = "jobworker.js";
    self.JobSchedulerDOM = class {
        ...
        async Init() {
            ...
            const e = this._runtimeInterface.GetScriptFolder() + Q;
        ...
        async _CreateJobWorker() {
            const e = this._jobWorkers.length,
                t = this._runtimeInterface.GetScriptFolder() + ee,
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _GetAudioBuffer(e, t, i, s, n) {
            ...
            return this._audioBuffers.push(o), s && this._playMusicAsSound && (this._lastMusicBuffer = o), await o.Load(), this._loadedAudioUrls.has(e) || (this.PostToRuntime("buffer-metadata", {
                originalUrl: e,
                duration: o.GetDuration()
            }), this._loadedAudioUrls.add(e)), o
        }
        async _GetAudioInstance(e, t, i, s, n) {
            ...
            const o = await this._GetAudioBuffer(e, t, i, n);
            if (o.WasReleased()) throw new Error(`buffer '${e}' unloaded while loading`);
            const a = o.CreateInstance(s);
        ...
        async _Play(e) {
            const t = e.originalUrl,
                ...
                h = e.stereoPan;
            let c = e.off;
            c > 0 && !e.trueClock && (c += this.GetAudioCurrentTime()), this._lastPlayedTags = o.slice(0), this._AddPendingTags(o);
            try {
                this._lastAudioInstance = await this._GetAudioInstance(t, i, s, o, n), l ? (this._lastAudioInstance.SetPannerEnabled(!0), this._lastAudioInstance.SetPan(l.x, l.y, l.z, l.angle, l.innerAngle, l.outerAngle, l.outerGain), l.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(l.uid)) : "number" == typeof h && 0 !== h ? (this._lastAudioInstance.SetStereoPannerEnabled(!0), this._lastAudioInstance.SetStereoPan(h)) : (this._lastAudioInstance.SetPannerEnabled(!1), this._lastAudioInstance.SetStereoPannerEnabled(!1)), this._lastAudioInstance.Play(a, r, d, c)
            } catch (e) {
        ...
        async _AddEffect(e) {
            ...
            if ("convolution" === t) try {
                o = await this._GetAudioBuffer(e.bufferOriginalUrl, e.bufferUrl, e.bufferType, !1)
            } catch (e) {
            ...
            for (const a of i) {
                ...
                else if ("convolution" === t) n = new self.C3AudioConvolveFX(this, o.GetAudioBuffer(), ...s), n._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
        ...
        _SetEffectParam(e) {
            ...
            for (const e of t) {
                const t = this._effects.get(e.toLowerCase());
                !t || i < 0 || i >= t.length || t[i].SetParam(s, n, o, a)
            }
            this._PostUpdatedFxState()
        }
        _RemoveEffects(e) {
        ...
        async _LoadAudioInstance(e, t) {
            ...
            let h = null;
            try {
                h = await this._GetAudioInstance(i, s, n, a, o)
            } catch (e) {
...
};
{
    ...
    self.C3AudioInstance = class {
        ...
        SetPan(e, t, i, s, n, o, a) {
            if (!this._isPannerEnabled) return;
            this.SetPanXYZA(e, t, i, s);
            const r = self.AudioDOMHandler.ToDegrees;
            this._pannerConeParams[0] !== r(n) && (this._pannerConeParams[0] = r(n), this._pannerNode.coneInnerAngle = r(n)), this._pannerConeParams[1] !== r(o) && (this._pannerConeParams[1] = r(o), this._pannerNode.coneOuterAngle = r(o)), this._pannerConeParams[2] !== a && (this._pannerConeParams[2] = a, this._pannerNode.coneOuterGain = a)
        }
        SetPanXYZA(e, t, i, s) {
            if (!this._isPannerEnabled) return;
            const n = this._pannerPosition,
                o = this._pannerOrientation,
                a = Math.cos(s),
                r = Math.sin(s);
            n[0] === e && n[1] === t && n[2] === i || (n[0] = e, n[1] = t, n[2] = i, this._pannerNode.setPosition(...n)), o[0] === a && o[1] === r && 0 === o[2] || (o[0] = a, o[1] = r, o[2] = 0, this._pannerNode.setOrientation(...o))
        }
...
};
{
    ...
    self.C3AudioFilterFX = class extends ne {
    ...
    }, self.C3AudioDelayFX = class extends ne {
        constructor(e, t, i, s) {
    ...
    }, self.C3AudioConvolveFX = class extends ne {
        constructor(e, t, i, s) {
    ...
    }, self.C3AudioFlangerFX = class extends ne {
    ...
    }, self.C3AudioPhaserFX = class extends ne {
        constructor(e, t, i, s, n, o, a) {
    ...
    }, self.C3AudioGainFX = class extends ne {
        constructor(e, t) {
    ...
    }, self.C3AudioStereoPanFX = class extends ne {
        constructor(e, t) {
    ...
    }, self.C3AudioTremoloFX = class extends ne {
        constructor(e, t, i) {
    ...
    }, self.C3AudioRingModFX = class extends ne {
        constructor(e, t, i) {
    ...
    }, self.C3AudioDistortionFX = class extends ne {
        constructor(e, t, i, s, n, o) {
    ...
    }, self.C3AudioCompressorFX = class extends ne {
        constructor(e, t, i, s, n, o) {
        ...
        SetParam(e, t, i, s) {}
    }, self.C3AudioAnalyserFX = class extends ne {
        constructor(e, t, i) {
    ...
    const oe = "touch",
        ae = class extends self.DOMHandler {
            constructor(e) {
                super(e, oe), this.AddRuntimeMessageHandler("request-permission", (e => this._OnRequestPermission(e)))
            }
...
function f(e, t, i) {
    ...
    n.id = t, s.parentNode.insertBefore(n, s), n.onload = i, n.src = e
}

function h() {
    let e = document.createElement("style");
    e.innerHTML = "\n  canvas {\n    user-select: none !important;\n    -webkit-user-select: none !important;\n    -moz-user-select: none !important;\n    -ms-user-select: none !important;\n  }", document.head.appendChild(e), window.addEventListener("keydown", (e => {
        ...
        setUpEventListeners(e, t) {
            ...
            const d = e => {
                if (t.poki_gameId && t.poki_doBeacon) {
                    let i = Date.now();
                    if (i - n < 1e3 * r || a <= 0) return;
                    n = i, a--, navigator.sendBeacon(`https://leveldata.poki.io/${e}`, t.poki_gameId)
                }
            };
            p("loadingStart", (() => {
                o.gameLoadingStart()
            })), p("loadingEnd", (() => {
                o.gameLoadingFinished(), d("loadingEnd")
            })), p("gameplayStart", (() => {
                d("gameplayStart"), !i.gameplayStarted && (i.gameplayStarted = !0, o.gameplayStart())
            })), p("gameplayStop", (() => {
                d("gameplayStop"), i.gameplayStarted && (i.gameplayStarted = !1, o.gameplayStop())
            })), p("interstitial", (() => {
                d("interstitial"), s("adStarted", i.lastRequestedAd), o.commercialBreak().then((() => {
                    s("interstitialEnd", !0)
                }))
            })), p("rewarded", (() => {
                d("rewarded");
...
const r = {
    ...
    init: (e, t = !1, i = {}) => new Promise((async s => {
        if (a = k.find((t => t.name.toLowerCase() === e.toLowerCase())), a)
            if (S = !0, a.enableOnlyInProduction && t) S = !1, s();
            else if (a.implementation.preInit && await a.implementation.preInit(t, i), a.scriptSrc) {
            const e = async () => {
                o = a.sdk, a.implementation.setUpEventListeners(t, i), a.implementation.init && await a.implementation.init(t, i), r.loadingStart(), s()
            };
    ...
    loadingStart() {
        s("loadingStart"), s("loadingProgress", 0)
    },
    loadingEnd() {
        s("loadingProgress", 100), s("loadingEnd")
    },
    gameplayStart() {
        s("gameplayStart")
    },
    ...
    interstitial: () => (i.lastRequestedAd = "interstitial", a && a.hasAds && !a.noInterstitial ? new Promise((e => {
        let t = i.gameplayStarted;
        t && r.gameplayStop(), s("interstitial"), y("interstitialEnd", ((...i) => {
            t && r.gameplayStart(), e(...i)
        }))
    })) : (s("adStarted", i.lastRequestedAd), Promise.resolve(!1))),
    rewarded: () => (i.lastRequestedAd = "rewarded", a && a.hasAds && !a.noRewarded ? new Promise((e => {
        let t = i.gameplayStarted;
        t && r.gameplayStop(), s("rewarded"), y("rewardedEnd", ((...i) => {
            t && r.gameplayStart(), e(...i)
        }))
    })) : (s("adStarted", i.lastRequestedAd), Promise.resolve(!0))),
    onAdStarted(e) {
        p("adStarted", e)
    },
...
function E(e) {
    return class extends e {
        constructor(e) {
            super(e), this.AddRuntimeMessageHandlers([
                ["Init", this.Init.bind(this)],
                ["LoadingEnd", r.loadingEnd],
                ["GameplayStart", r.gameplayStart],
                ["GameplayStop", r.gameplayStop],
                ["Interstitial", r.interstitial],
                ["Rewarded", r.rewarded],
                ["AnalyticsEvent", r.analyticsEvent]
            ])
        }
        async Init({
            debug: e,
...
}));
{
    ...
    function he() {}
    window.addEventListener("beforeinstallprompt", (e => (e.preventDefault(), re = e, de && de._OnBeforeInstallPrompt(), !1)));
    const ce = "browser",
        ue = class extends self.DOMHandler {
            constructor(e) {
                super(e, ce), this._exportType = "", this.AddRuntimeMessageHandlers([
            ...
            Attach() {
                re ? this._OnBeforeInstallPrompt() : de = this, window.addEventListener("appinstalled", (() => this._OnAppInstalled()))
            }
            ...
            async _OnRequestInstall() {
                ...
                try {
                    return re.prompt(), {
                        result: (await re.userChoice).outcome
                    }
                } catch (e) {
            ...
            _OnExitFullscreen() {
                if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!1), this._iRuntime._SendWrapperMessage({
                    ...
                    let e;
                    document.exitFullscreen ? e = document.exitFullscreen() : document.mozCancelFullScreen ? e = document.mozCancelFullScreen() : document.msExitFullscreen ? e = document.msExitFullscreen() : document.webkitCancelFullScreen && (e = document.webkitCancelFullScreen()), e instanceof Promise && e.catch(he)
                }
            }
            _OnSetHash(e) {
    ...
    self.RuntimeInterface.AddDOMHandlerClass(ue)
} {
    const _e = "keyboard",
        me = class extends self.DOMHandler {
            constructor(e) {
                super(e, _e), this._isKeyboardLockSupported = !(!navigator.keyboard || !navigator.keyboard.lock), this.AddRuntimeMessageHandlers([
                    ["init", () => this._OnInit()],
    ...
    self.RuntimeInterface.AddDOMHandlerClass(me)
} {
    const pe = "localstorage",
        fe = class extends self.DOMHandler {
            constructor(e) {
                super(e, pe), this.AddRuntimeMessageHandlers([
                    ["init", () => this._Init()],
            ...
            async _Init() {
                ...
                try {
                    ...
                    e = !1, console.warn("[Construct] Error checking storage persisted state: ", t)
                }
                return {
                    isPersistent: e
                }
    ...
    self.RuntimeInterface.AddDOMHandlerClass(fe)
}
...
// Override fetch để chặn requests đến ad domains
...
// Chặn tất cả XMLHttpRequest đến ad domains
